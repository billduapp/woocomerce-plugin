...
class SettingPanel
{
    ...
    {
        $tabs['wc_billdu'] = __('MiniFaktúra', 'wc-billdu');
    ...
    {
        global $woocommerce_settings;
        echo '<img src="https://moja.minifaktura.sk/images/logo_color_sk.png">';
    ...
    function save_woo_settings_tab_content()
    {
        if (class_exists('WC_Admin_Settings')) {
            global $woocommerce_settings;
            $woocommerce_settings['wc_superfaktura'] = apply_filters('woocommerce_wc_superfaktura_settings', $this->get_settings());
...
'
        ...
        $invoice_settings[] = array(
            ...
            'default' => '[ATTRIBUTES] [SHORT_DESCR]',
            'type' => 'textarea',
        );
        $invoice_settings[] = array(
